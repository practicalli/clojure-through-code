...
{:code
 ...
 :id
 "f4857f3a-eb52-4712-b2dc-5965981b84e3"
...
{:code
 ...
 :id
 "8f013943-764d-4f65-8c01-9882b17a9f02"
 :line
 37
 :nrepl.middleware.print/options
 {:associative 1 :length 500 :level 50 :right-margin 72}
 ...
 "39898320-bb8e-4dd5-99d3-d1f32a865b5d"}
; debug: receive
{:id "8f013943-764d-4f65-8c01-9882b17a9f02"
 :ns "clojure-through-code.01-basics"
...
{:changed-namespaces
 ...
 ["state"]}
; debug: receive
{:id "f4857f3a-eb52-4712-b2dc-5965981b84e3"
 :ns "clojure-through-code.01-basics"
 :session "39898320-bb8e-4dd5-99d3-d1f32a865b5d"
 :value "nil"}
; debug: receive
